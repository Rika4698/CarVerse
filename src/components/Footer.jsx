...
export function Footer() {
  return (
    <footer className="py-24 bg-slate-50 dark:bg-slate-800 text-white border-t border-slate-200 dark:border-slate-600 min-h-screen">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-20 mb-24">
          <div className="max-w-md">
            ...
            <div className="flex gap-4">
              {[FaInstagram, FaTwitter, FaLinkedin].map((Icon, idx) => (
                <button key={idx} className="w-12 h-12 bg-slate-300 dark:bg-slate-500 rounded-full flex items-center justify-center hover:bg-primary hover:text-white dark:hover:bg-primary  dark:hover:text-white transition-all text-slate-600 dark:text-slate-800 shadow-sm border border-white/5">
                  <Icon size={20} />
                </button>
              ))}
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-16 lg:gap-24">
            <div className="space-y-8">
              <h6 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-900 dark:text-white">Showroom</h6>
            ...
            <div className="space-y-8">
              <h6 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-900 dark:text-white">Experience</h6>
              <div className="flex flex-col gap-4 text-xs font-bold text-slate-400 dark:text-white/50 tracking-widest">
            ...
            <div className="space-y-8 hidden sm:block">
              <h6 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-900 dark:text-white">Connect</h6>
              <div className="flex flex-col gap-4 text-xs font-bold text-slate-400 dark:text-white/50 tracking-widest">
        ...
        <div className="pt-12 border-t border-slate-300 dark:border-white/20 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-8 text-[10px] text-slate-300 dark:text-slate-500 font-black uppercase tracking-widest">
          ...
          <div className="flex items-center gap-3 px-6 py-3 bg-slate-200 dark:bg-white/5 rounded-full border border-slate-300 dark:border-white/5">
            <span className="text-[10px] text-slate-400 dark:text-white/30 font-black uppercase tracking-widest">Crafted for</span>
            <span className="text-[10px] text-primary font-black uppercase tracking-widest italic font-serif">Performance</span>
          </div>
        </div>
      </div>
    </footer>
